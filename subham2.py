...
def init_db():
    ...
    c.execute("""CREATE TABLE IF NOT EXISTS users (
                    ...
                    emergency_contact TEXT, aadhaar_number TEXT, address TEXT)""")
...
def view_user_profile(username):
    conn = sqlite3.connect("health_app.db")
    c = conn.cursor()
    c.execute("SELECT balance, emergency_contact, aadhaar_number, address FROM users WHERE username = ?", (username,))
...
def display_health_articles():
    articles = [
        {"title": "Healthy Eating", "link": "https://www.healthyeating.org"},
        {"title": "Exercise Tips", "link": "https://www.exercise.com"},
        {"title": "Mental Health Awareness", "link": "https://www.mentalhealth.gov"},
    ]
    st.write("Health Articles and Resources:")
...
def main():
    ...
    # --- Sidebar ---
    menu = ["Login", "Register", "Predict", "Consult Doctor", "Upload Prescription", "Video Call", "Feedback", "Health Articles", "Export Data"]
